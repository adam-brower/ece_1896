...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA1     ------> ADC1_IN6
    */
    GPIO_InitStruct.Pin = ADC_FLOW_SIG_IN_Pin|ADC_TEMP_SIG_IN_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(GPIOA, ADC_FLOW_SIG_IN_Pin|ADC_TEMP_SIG_IN_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = TFT_LITE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(TFT_LITE_GPIO_Port, &GPIO_InitStruct);
