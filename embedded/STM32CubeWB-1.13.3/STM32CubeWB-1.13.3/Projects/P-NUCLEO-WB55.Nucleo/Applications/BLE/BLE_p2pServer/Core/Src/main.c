...
static void MX_GPIO_Init(void)
{
  ...
  myStruct.Pin = SD_CS_Pin;
  myStruct.Mode = GPIO_MODE_OUTPUT_PP;
  myStruct.Pull = GPIO_NOPULL;
  myStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SD_CS_GPIO_Port, &myStruct);
